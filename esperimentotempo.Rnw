...
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.70\textwidth]{Report-024}
...
\begin{figure}[h]
  \centering
  \subfloat[][\emph{Interazione fattore A vs altri}.]{\includegraphics[width=.80\textwidth]{Report-030}} \,
\end{figure}
\clearpage
\begin{figure}[ht]\ContinuedFloat
  \centering
  \subfloat[][\emph{Interazione fattore B e C vs altri}.]{\includegraphics[width=.7\textwidth]{Report-031}} \,
