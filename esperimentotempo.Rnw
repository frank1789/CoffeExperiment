...
\begin{figure}[htb]
\centering
  \includegraphics[width=0.80\textwidth]{Report-027}
\caption{da inserire}
...
\begin{figure}[h]
\centering
  \includegraphics[width=0.80\textwidth]{Report-029}
...
\begin{figure}[h] 
\centering
 \includegraphics[width=0.70\textwidth]{Report-029}
...
Per comprendere meglio la bontà del modello realizzato e verificare le interazioni tra i fattori e come incidano sulla durata dell'estrazione del caffè, si generano i seguenti grafici di interazione [\ref{fig:subfig2}].
...
\begin{figure}[htb]
\centering
\subfloat[][\emph{Interazione fattore A vs altri}.\label{fig:subfig4}]
   {\includegraphics[width=.80\textwidth]{Report-030}} \,
\end{figure}
\begin{figure}[!h]\ContinuedFloat
\centering
\subfloat[][\emph{Interazione fattore B e C vs altri}.\label{fig:subfig5}]
   {\includegraphics[width=.65\textwidth]{Report-031}} \,
\subfloat[][\emph{Interazione fattore C e D vs altri}.\label{fig:subfig6}]
   {\includegraphics[width=.65\textwidth]{Report-032mod}}
