...
\end{figure}
%
\newline\noindent Si osserva un elevato valore del \emph{p-value}, per i fattori D e le relative interazioni, data la loro bassa significatività si assume una relazione ($Yield \sim A * C + B * E$) ricalcolando \textsc{anova}:
<<>>=
...
\begin{figure}
\centering
\subfloat[][\emph{Interazione fattore A vs altri}.]
   {\includegraphics[width=.65\textwidth]{Report-015}} \,
\subfloat[][\emph{Interazione fattore B e C vs altri}.]
   {\includegraphics[width=.65\textwidth]{Report-016}} \\
\end{figure}
\begin{figure}[htb]\ContinuedFloat
\centering
\subfloat[][\emph{Interazione fattore C e D vs altri}.]
   {\includegraphics[width=.65\textwidth]{Report-017mod}}
\caption{Grafici delle interazioni tra fattori.}
\label{fig:subfig}
\end{figure}
\newpage Dai grafici si osserva:
\begin{itemize}
